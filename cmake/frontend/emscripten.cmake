include("${CMAKE_CURRENT_LIST_DIR}/npm_install.cmake")
...
function(nui_prepare_emscripten_target)
    ...
    if (NOT NUI_PREPARE_EMSCRIPTEN_TARGET_ARGS_NO_NPM_INSTALL)
        add_npm_install(
            NPM_EXECUTABLE "${NUI_NPM}"
            WORKING_DIRECTORY ${CMAKE_BINARY_DIR}
            TARGET_NAME ${NUI_PREPARE_EMSCRIPTEN_TARGET_ARGS_TARGET}-npm-install
            INSTALL_ARGS ${NUI_PREPARE_EMSCRIPTEN_TARGET_ARGS_NPM_INSTALL_ARGS}
            OUTPUTS ${NUI_PREPARE_EMSCRIPTEN_TARGET_ARGS_NPM_EXTRA_OUTPUTS}
        )
    endif()
